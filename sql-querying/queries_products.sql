...
--1. INSERT INTO products (name, price, can_be_returned) VALUES ('chair', 44.0, 'f');
...
--7. INSERT INTO products (name, price, can_be_returned, color) VALUES ('cup', 25, 'f', 'red'); 

--8.SELECT name FROM products WHERE can_be_returned = 't';
